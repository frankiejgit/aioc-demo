...
LEARNING_RATE = 2e-5
EPOCHS = 3
BUCKET_NAME = "aioc-demo-bucket"
OUTPUT_DIR = "models/distilbert-sst2" # Path to save model in Cloud Storage

# Initialize distributed training
torch.distributed.init_process_group(backend="nccl") # use 'nccl' for GPUs
